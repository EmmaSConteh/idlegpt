...
abs_srcdir=	/Users/emmaconteh/Desktop/SpringQuarter/CSE190/group-project-food-enjoyers
abs_builddir=	/Users/emmaconteh/Desktop/SpringQuarter/CSE190/group-project-food-enjoyers
...
SHLIB_SUFFIX=	.so
EXT_SUFFIX=	.cpython-310d-darwin.so
...
OPENSSL_INCLUDES=-I/usr/local/opt/openssl@3.0/include
OPENSSL_LIBS=-lssl -lcrypto
OPENSSL_LDFLAGS=-L/usr/local/opt/openssl@3.0/lib
OPENSSL_RPATH=
...
CONFIG_ARGS=	 '--with-pydebug' '--with-openssl=/usr/local/opt/openssl@3.0'
...
BUILD_GNU_TYPE=	x86_64-apple-darwin22.3.0
HOST_GNU_TYPE=	x86_64-apple-darwin22.3.0

# Tcl and Tk config info from --with-tcltk-includes and -libs options
TCLTK_INCLUDES=	-I/usr/local/Cellar/tcl-tk/8.6.13_3/include/tcl-tk
TCLTK_LIBS=	-L/usr/local/Cellar/tcl-tk/8.6.13_3/lib -ltk8.6 -ltkstub8.6 -ltcl8.6 -ltclstub8.6
